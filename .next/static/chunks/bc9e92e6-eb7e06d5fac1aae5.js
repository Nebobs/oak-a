"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{Bt:function(){return sy},ET:function(){return sg},IO:function(){return i6},JU:function(){return iL},PL:function(){return sf},QT:function(){return sc},Xo:function(){return sn},ad:function(){return iM},hJ:function(){return ix},oe:function(){return sm}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nL{constructor(){this.Tr=new es(nV.Er),this.dr=new es(nV.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){let n=new nV(e,t);this.Tr=this.Tr.add(n),this.dr=this.dr.add(n)}Rr(e,t){e.forEach(e=>this.addReference(e,t))}removeReference(e,t){this.Vr(new nV(e,t))}mr(e,t){e.forEach(e=>this.removeReference(e,t))}gr(e){let t=new K(new B([])),n=new nV(t,e),r=new nV(t,e+1),i=[];return this.dr.forEachInRange([n,r],e=>{this.Vr(e),i.push(e.key)}),i}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){let t=new K(new B([])),n=new nV(t,e),r=new nV(t,e+1),i=tp();return this.dr.forEachInRange([n,r],e=>{i=i.add(e.key)}),i}containsKey(e){let t=new nV(e,0),n=this.Tr.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class nV{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return K.comparator(e.key,t.key)||M(e.wr,t.wr)}static Ar(e,t){return M(e.wr,t.wr)||K.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iB{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new A(C.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new A(C.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return M(this._lat,e._lat)||M(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sc(e){e=iS(e,iD);let t=iS(e.firestore,iO);return(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new id({next:o=>{s.Za(),t.enqueueAndForget(()=>rq(e,a));let l=o.docs.has(n);!l&&o.fromCache?i.reject(new A(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new rK(new e8(n.path),s,{includeMetadataChanges:!0,_a:!0});return rU(e,a)})(await iw(e),e.asyncQueue,t,n,r)),r.promise})(iF(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new sd(e);return new sl(e,i,t._key,r,new so(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}class sd extends sa{constructor(e){super(),this.firestore=e}convertBytes(e){return new iP(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iD(this.firestore,null,t)}}function sf(e){e=iS(e,ib);let t=iS(e.firestore,iO),n=iF(t),r=new sd(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new A(C.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new id({next:n=>{s.Za(),t.enqueueAndForget(()=>rq(e,a)),n.fromCache&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new rK(n,s,{includeMetadataChanges:!0,_a:!0});return rU(e,a)})(await iw(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sh(t,r,e,n)))}function sm(e){return sp(iS(e.firestore,iO),[new tz(e._key,tx.none())])}function sg(e,t){var n;let r=iS(e.firestore,iO),i=iL(e),s=(n=e.converter)?n.toFirestore(t):t;return sp(r,[(function(e,t,n,r,i,s={}){let a,o;let l=e.Qu(s.merge||s.mergeFields?2:0,t,n,i);iZ("Data must be an object, but it was:",l,r);let u=iX(r,l);if(s.merge)a=new eo(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=function(e,t,n){if((t=(0,h.m9)(t))instanceof iU)return t._internalPath;if("string"==typeof t)return i1(e,t);throw i2("Field path arguments must be of type string or ",e,!1,void 0,n)}(t,r,n);if(!l.contains(i))throw new A(C.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);(function(e,t){return e.some(e=>e.isEqual(t))})(e,i)||e.push(i)}a=new eo(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new iK(new eM(u),a,o)})(iW(e.firestore),"addDoc",i._key,s,null!==e.converter,{}).toMutation(i._key,tx.exists(!1))]).then(()=>i)}function sp(e,t){return function(e,t){let n=new S;return e.asyncQueue.enqueueAndForget(async()=>r3(await iv(e).then(e=>e.syncEngine),t,n)),n.promise}(iF(e),t)}function sy(){return new iH("serverTimestamp")}new WeakMap,function(e=!0){p=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iO(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new A(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.3",void 0),(0,o.KN)(m,"4.7.3","esm2017")}()}}]);